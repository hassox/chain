...
function Environment(request, response){
  ...
  response.chainEnvironment = this; // Give the response object a reference to this for the callbacks
...
Environment.prototype = {
  ...
  next              : function(linkOrCallback, callback) {
    ...
    // call the link
    this.chain.emit("linkTransition", link, this);
  },
